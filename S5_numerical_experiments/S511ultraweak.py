...
EXPERIMENT_REFERENCE = "S511ultraweak"
...
DEXACT = "lambda x : 4*keras.ops.cos(4*x)*keras.ops.sin(x/2)+1/2*keras.ops.cos(x/2)*keras.ops.sin(4*x)"
...
from config import A, B, SOURCE, EXACT, DEXACT
