...
def save_and_plot_net(x, nets, file=False):
    ...
    plt.legend()
    plt.xlabel(r"$x$")
    plt.title(r"$u^{\boldsymbol{\alpha},\boldsymbol{\omega}}(x)$ vs. $u^*(x)$")
    ...
    plt.legend()
    plt.xlabel(r"$x$")
    plt.title(r"$e(u^{\boldsymbol{\alpha},\boldsymbol{\omega}}) = u^{\boldsymbol{\alpha},\boldsymbol{\omega}}(x) - u^*(x)$")
    auto_format_y_axis()
    figures.append(plt.gcf())
    plt.show()
    ...
    plt.legend()
    plt.xlabel(r"$x$")
    plt.title(r"$\displaystyle r_M(u^{\boldsymbol{\alpha},\boldsymbol{\omega}}) = \sum_{m=1}^M r(u^{\boldsymbol{\alpha},\boldsymbol{\omega}},v_m) \; v_m$", pad=20)
    auto_format_y_axis()
    ...
    plt.legend()
    plt.xlabel(r"$x$")
    plt.title(r"$r_M(u^{\boldsymbol{\alpha},\boldsymbol{\omega}}) - r(u^{\boldsymbol{\alpha},\boldsymbol{\omega}})$")
    auto_format_y_axis()
    figures.append(plt.gcf())
    plt.show()
...
def save_and_plot_loss(history, file=False):
    ...
    plt.plot(iterations, history["errorGD"],label=r"$\Vert e(u^{\boldsymbol{\alpha},\boldsymbol{\omega}})\Vert_{H^1_0(\Omega))}^2$ Adam", color="red", linestyle="--", lw=1)
    plt.plot(iterations, history["errorLSGD"],label=r"$\Vert e(u^{\boldsymbol{\alpha},\boldsymbol{\omega}})\Vert_{H^1_0(\Omega))}^2$ LS/Adam", color="purple", linestyle="--", lw=1)
    plt.yscale("log")
    plt.xlabel("Iteration")
    plt.legend()
    plt.title("Evolution of the loss and the error in the energy norm")
    figures.append(plt.gcf())
    plt.show()
